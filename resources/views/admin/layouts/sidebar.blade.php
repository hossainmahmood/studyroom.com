     ...
     <li class="mb-1">
       ...
       <div class="collapse" id="teacher-collapse">
         <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
           <li><a href="{{ url('/teachers') }}" class="link-dark rounded"> All Teachers</a></li>
           <li><a href="{{ url('/teachers/create') }}" class="link-dark rounded">Add New</a></li>
         </ul>
       </div>
     </li>
     <li class="mb-1">
       ...
       <div class="collapse" id="student-collapse">
         <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small" id="studentTabs">
           <li><a href="{{ url('/students') }}" class="link-dark rounded">All Students</a></li>
           <li><a href="{{ url('/students/create') }}" class="link-dark rounded" onclick="">Add New</a></li>
         </ul>
       </div>
     </li>
     <li class="mb-1">
       ...
       <div class="collapse" id="orders-collapse">
         <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
           <li><a href="{{ url('/videos') }}" class="link-dark rounded">Youtube Lectures</a></li>
           <li><a href="{{ url('/videos/create') }}" class="link-dark rounded">Add a Lecture</a></li>
         </ul>
       </div>
     </li>
