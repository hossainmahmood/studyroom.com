     ...
     <li class="mb-1">
       ...
       <div class="collapse" id="orders-collapse">
         <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
           ...
           <li><a href="<?php echo e(url('/videos/create')); ?>" class="link-dark rounded">Add a Lecture</a></li>
         </ul>
       </div>
     </li>
...
<?php /**PATH /home/studyroo/hmacademy.studyroombd.com/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>