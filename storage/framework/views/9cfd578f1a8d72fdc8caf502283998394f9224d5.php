        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo e(route('teachers.index')); ?>">Teachers Profile</a>
                    <a class="dropdown-item" href="<?php echo e(route('teachers.create')); ?>">Add Teacher</a>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo e(url('/videos')); ?>">Youtube Tutorials</a>
                    <a class="dropdown-item" href="<?php echo e(url('/videos/create')); ?>">Add new tutorial</a>
...
<?php /**PATH C:\xampp\htdocs\studyroombd.com\resources\views/admin/layouts/adminnavigation.blade.php ENDPATH**/ ?>