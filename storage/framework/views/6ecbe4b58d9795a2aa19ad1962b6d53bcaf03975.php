...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(url('teachers')); ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="sex" placeholder="Male/Femal" name="sex"></input>
            </div>
        </div>
        <div class="form-group row">
            <label for="dob" class="col-sm-2 col-form-label">Date of Birth</label>
            <div class="col-sm-10">
                <input type="date" class="form-control" id="dob" placeholder="Date Of Birth" name="dob"></input>
            </div>
        </div>
        <div class="form-group row">
...
<?php echo $__env->make('admin.layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bdposhak/public_html/laravel8/resources/views/admin/teacher/create.blade.php ENDPATH**/ ?>